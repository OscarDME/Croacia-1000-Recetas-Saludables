...
export const copy = {
  metadata: {
    title: "Esencia Pro | 1000 zdravih recepata 2.0",
    description:
  ...
  brand: {
    name: "Esencia Pro",
    tagline: "1000 zdravih recepata 2.0",
  },
    ...
    items: [
      {
        ...
        tag: "BONUS 1",
        title: "E-knjiga: 15 zdravih juha",
        desc: "Sadrži 15 recepata za tople juhe s niskim udjelom ugljikohidrata i šećera.",
        value: "15 €",
      },
      {
        image: "/bonuses/batidos.webp",
        tag: "BONUS 2",
        title: "E-knjiga: 10 zdravih smoothieja",
        desc: "10 recepata za osvježavajuće smoothieje, siromašne ugljikohidratima i šećerima.",
        value: "15 €",
      },
      {
        image: "/bonuses/snacks.webp",
        tag: "BONUS 3",
        title: "E-knjiga: 15 zdravih grickalica",
        desc: "15 ideja za brze i zdrave međuobroke za osobe s dijabetesom.",
        value: "15 €",
      },
      {
  ...
  finalCta: {
    ...
    bundleList: [
      ...
      "Bonus 1 — 15 zdravih juha",
      "Bonus 2 — 10 zdravih smoothieja",
      "Bonus 3 — 15 zdravih grickalica",
  ...
  faq: {
    authorRole: "Esencia Pro · Tim za zdravu prehranu",
    authorHeadline: "Ukusna hrana koja brine o tvom zdravlju",
    authorBio:
      "U Esencia Pro vjerujemo da ti dijabetes ne bi smio oduzeti užitak u hrani. Svaki pojedini recept kreiran je tako da možeš uživati bez grižnje savjesti i održavati glukozu pod potpunom kontrolom.",
    authorImageAlt: "Esencia Pro tim",

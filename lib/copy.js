...
export const copy = {
    ...
    items: [
      {
        ...
        desc: "Ogroman izbor uravnoteženih i hranjivih recepata – od ručkova i večera do zdravih domaćih umaka i krema.",
      },
      {
        icon: "BookOpen",
  ...
  finalCta: {
    ...
    headline:
      "UZMI NAŠU DIGITALNU KNJIGU DANAS UZ NEVJEROJATAN POPUST!",
    subUrgency:
    ...
    guaranteeText:
      "Još uvijek razmišljaš? Ne brini, nema apsolutno nikakvog rizika! Tvoje zdravlje to zaslužuje. Imaš 7-dnevno jamstvo na zadovoljstvo.",
    guaranteeImageAlt: "Jamstvo",
    regularPriceLabel: "Umjesto",
    regularPrice: "44.50 €",
    offerPrice: "8.90 €",
    discountBadge: "80% POPUSTA",
    urgencyText: "PLAĆANJE JE 100% SIGURNO",
  ...
  faq: {
    authorRole: "Chef Petra Horvat i Tim za zdravu prehranu",
